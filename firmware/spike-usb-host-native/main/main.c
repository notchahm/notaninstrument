...
# endif // ENABLE_ENUM_FILTER_CALLBACK
        // Stock example hardcodes BIT0 here, which on a dual-peripheral
        // target follows the same 0=FS/1=HS numbering the TinyUSB spike
        // got bitten by (docs/bring-up-plan.md step 2) -- BIT0 very likely
        // selects the FS peripheral, not this board's native HS USB-A
        // ports. usb_host.h's own doc comment: "Set to 0 to use the
        // default peripheral... on High-Speed capable targets, the
        // default is the High-Speed peripheral." Use that instead of
        // hardcoding a specific bit.
        .peripheral_map = 0,
    };
